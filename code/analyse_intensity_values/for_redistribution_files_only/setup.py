...
if __name__ == '__main__':
    setup_dict = {
        'name': 'analyse_intensity_values-R2022b',
        'version': '9.13',
        'description': 'A Python interface to analyse_intensity_values',
        'author': 'MathWorks',
        'url': 'https://www.mathworks.com/',
        'platforms': ['Linux', 'Windows', 'macOS'],
        'packages': [
            'analyse_intensity_values'
        ],
        'package_data': {'analyse_intensity_values': ['*.ctf']}
    }
