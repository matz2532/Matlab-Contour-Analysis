analyse_intensity_values MATLAB Python Package
...
2. Installing the analyse_intensity_values Package

A. Change to the directory that contains the file setup.py and the subdirectory 
analyse_intensity_values. If you do not have write permissions, copy all its contents to 
a temporary location and change to that directory.
...
3. Using the analyse_intensity_values Package

The analyse_intensity_values package is on your Python path. To import it into a Python 
